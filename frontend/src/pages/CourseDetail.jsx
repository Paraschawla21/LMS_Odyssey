...
function CourseDetail() {
    ...
    return (
        <>
            <div className="bg-gray-900  text-gray-200 ">
                <div className="container px-5 py-16 mx-auto flex flex-wrap items-center ">
                    ...
                    <div class="lg:w-3/12 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-fit mt-10 md:mt-0">
                        <button
                            onClick={handleAlert}
                            class="flex-shrink-0 text-white  bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded-lg text-lg "
                        >
                            Enroll Now
                        </button>
                    </div>
            ...
            <div className="container px-5 py-16 mx-auto flex flex-wrap items-center ">
                <h1 className="title-font font-medium text-3xl pb-16">
                    Syllabus
                </h1>
                {course.sections ? (
